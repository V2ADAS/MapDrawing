...
BlueMan::BlueMan()
{
    ...
    connect(discoveryAgent, &QBluetoothDeviceDiscoveryAgent::deviceDiscovered,
            this, &BlueMan::addDevice);
    connect(discoveryAgent, &QBluetoothDeviceDiscoveryAgent::errorOccurred,
            this, &BlueMan::deviceScanError);
    connect(discoveryAgent, &QBluetoothDeviceDiscoveryAgent::finished,
            this, &BlueMan::deviceScanFinished);
...
void BlueMan::startDeviceDiscovery()
{
    qDeleteAll(devices);
    devices.clear();
    emit devicesUpdated();
...
void BlueMan::stopDeviceDiscovery()
{
    if (discoveryAgent->isActive())
        discoveryAgent->stop();
}
...
void BlueMan::addDevice(const QBluetoothDeviceInfo &info)
{
...
void BlueMan::deviceScanFinished()
{
...
QVariant BlueMan::getDevices()
{
    return QVariant::fromValue(devices);
}

QVariant BlueMan::getServices()
{
    return QVariant::fromValue(m_services);
}

QVariant BlueMan::getCharacteristics()
{
    return QVariant::fromValue(m_characteristics);
}

QString BlueMan::getUpdate()
{
    return m_message;
}

void BlueMan::scanServices(const QString &address)
{
    ...
    if (!controller) {
        ...
        connect(controller, &QLowEnergyController::connected,
                this, &BlueMan::deviceConnected);
        connect(controller, &QLowEnergyController::errorOccurred, this, &BlueMan::errorReceived);
        connect(controller, &QLowEnergyController::disconnected,
                this, &BlueMan::deviceDisconnected);
        connect(controller, &QLowEnergyController::serviceDiscovered,
                this, &BlueMan::addLowEnergyService);
        connect(controller, &QLowEnergyController::discoveryFinished,
                this, &BlueMan::serviceScanDone);
    }
...
void BlueMan::addLowEnergyService(const QBluetoothUuid &serviceUuid)
{
    //! [les-service-1]
...
void BlueMan::connectToService(const QString &uuid)
{
    ...
    if (service->state() == QLowEnergyService::RemoteService) {
        ...
        connect(service, &QLowEnergyService::stateChanged,
                this, &BlueMan::serviceDetailsDiscovered);
    ...
    QTimer::singleShot(0, this, &BlueMan::characteristicsUpdated);
}

void BlueMan::deviceConnected()
{
...
void BlueMan::errorReceived(QLowEnergyController::Error /*error*/)
{
    qWarning() << "Error: " << controller->errorString();
    setUpdate(u"Back\n(%1)"_s.arg(controller->errorString()));
}

void BlueMan::setUpdate(const QString &message)
{
    m_message = message;
    emit updateChanged();
}

void BlueMan::disconnectFromDevice()
{
...
void BlueMan::deviceDisconnected()
{
    qWarning() << "Disconnect from device";
    emit disconnected();
}

void BlueMan::serviceDetailsDiscovered(QLowEnergyService::ServiceState newState)
{
...
void BlueMan::deviceScanError(QBluetoothDeviceDiscoveryAgent::Error error)
{
...
bool BlueMan::hasControllerError() const
{
    return (controller && controller->error() != QLowEnergyController::NoError);
}

bool BlueMan::isRandomAddress() const
{
    return randomAddress;
}

void BlueMan::setRandomAddress(bool newValue)
{
